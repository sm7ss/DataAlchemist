...
class DistributionDecisionMaker: 
    def __init__(self, config_threshold_eda: BaseModel):
        self.tail= config_threshold_eda.distribution_decision_maker.tail_length
        self.scaler_con= config_threshold_eda.distribution_decision_maker.scaler_concentration
...
class OutlierDecisionMaker: 
    def __init__(self, config_threshold_eda: BaseModel):
        self.scaler= config_threshold_eda.outlier_decision_maker.scaler
        self.filter= config_threshold_eda.outlier_decision_maker.filter
        self.impute= config_threshold_eda.outlier_decision_maker.impute
        self.flag= config_threshold_eda.outlier_decision_maker.flag
        self.transform= config_threshold_eda.outlier_decision_maker.transform
...
class CorrelationDecisionMaker: 
    def __init__(self, config_threshold_eda: BaseModel):
        self.sampling= config_threshold_eda.correlation_decision_maker.sampling
        self.handle_nulls= config_threshold_eda.correlation_decision_maker.handle_nulls
        self.threshold= config_threshold_eda.correlation_decision_maker.threshold
...
class CategoryDominanceDecisionMaker: 
    def __init__(self, config_threshold_eda: BaseModel):
        self.few_cat= config_threshold_eda.category_decision_maker.threshold_ml_analysis.few_categories
        self.many_cat= config_threshold_eda.category_decision_maker.threshold_ml_analysis.many_categories
        self.hight_cardinality= config_threshold_eda.category_decision_maker.threshold_ml_analysis.high_cardinality
        self.nrv_and_rc= config_threshold_eda.category_decision_maker.threshold_ml_analysis.no_rare_values_and_reasonable_categories
...
class AnalysisData: 
    def __init__(self, frame: pl.DataFrame, analysis: Dict[str, Any], config_threshold_eda: BaseModel):
        self.frame= frame
        self.analysis= analysis
        self.config_values= config_threshold_eda
        
        self.distribution_decision= DistributionDecisionMaker(config_threshold_eda=self.config_values)
        self.outlier_decision= OutlierDecisionMaker(config_threshold_eda=self.config_values)
        self.correlation_decision= CorrelationDecisionMaker(config_threshold_eda=self.config_values)
        self.category_decision= CategoryDominanceDecisionMaker(config_threshold_eda=self.config_values)
