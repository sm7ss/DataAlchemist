...
class EdaNullValues: 
    def __init__(self, frame: pl.DataFrame, config: BaseModel):
        self.frame= frame
        self.column_percentage= config.eda.null_values.null_values_percent_column
        self.row_percentage= config.eda.null_values.null_values_percent_row
    ...
    def total_nulls_values(self) -> Dict[str, Any]: 
        ...
        for col in columns: 
            ...
            if null_count_col > 0: 
                ...
                if null_percent < self.column_percentage:
                    ...
                    if row_null_percent < self.row_percentage: 
